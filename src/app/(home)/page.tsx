...
export default async function HomePage() {
  ...
  return <Shell active="upload">
    ...
    <main id="main-content" className="welcome">
      <div className="welcome-copy"><h1>Your notes.<br />Ready for the web.</h1><p>Give your technical notes a little breathing room.<br className="desktop-break" /> Write or upload. Edit your note. Share an idea.</p></div>
      <Link href="/sign-in" className="upload-invitation">
        ...
        <span>Start writing, or import Markdown and LaTeX</span>
        <span className="button primary">Sign in to get started <ArrowUpRight size={16} /></span>
        <small>Your notes stay private until you publish.</small>
      </Link>
      <div className="journey" aria-label="How it works"><span><FileUp size={15} /> Write or upload</span><span><Check size={15} /> Edit & publish</span><span><Link2 size={15} /> Share the link</span></div>
